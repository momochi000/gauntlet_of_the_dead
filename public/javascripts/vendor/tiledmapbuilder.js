...
Crafty.c("TiledMapBuilder", {  	  				
	...
	tileMapBuilderSetting: {
		 ...
		 RENDER_METHOD_BUFFEREDCANVAS	:'BufferedCanvas',
	...
	_callback:null,
    init: function() {    			    	  			    
        if(this.has(this.tileMapBuilderSetting.RENDER_METHOD_CANVAS)){
          this._renderMethod = this.tileMapBuilderSetting.RENDER_METHOD_CANVAS;
        }else if(this.has(this.tileMapBuilderSetting.RENDER_METHOD_DOM)){
          this._renderMethod = this.tileMapBuilderSetting.RENDER_METHOD_DOM;
        }else if(this.has(this.tileMapBuilderSetting.RENDER_METHOD_BUFFEREDCANVAS)){
          console.log("DEBUG: initializing tiledmapbuilder with bufferedcanvas");
          this._renderMethod = this.tileMapBuilderSetting.RENDER_METHOD_BUFFEREDCANVAS;
        }
